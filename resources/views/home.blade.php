...
<body class="bg-gray-100 font-family-karla flex">
            ...
            <main class="w-full flex-grow p-6">
               ...
               <!-- Button trigger modal -->
                ...
                <form action="/home" method="GET" class="flex items-center">   
                    ...
                    <button type="submit" class="p-2.5 ml-2 text-sm font-medium mt-3 text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td class="px-6 py-4 justify-between">
                    <a href="/tampilkandata/{{$row->id}}" class="btn btn-primary text-white">Edit</a>
                    <a href="#"class="btn btn-danger delete text-white" data-id="{{ $row->id }}" data-nama="{{ $row->nama }}">Delete</a>
                </td>
            </tr>
            @endforeach
            </tbody>
    ...
    <!-- Bootstrap -->
    <script>https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css</script>
